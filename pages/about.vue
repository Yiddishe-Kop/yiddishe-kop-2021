<template>
  <div>
    ...
    <div class="relative mt-24 text-center">
      ...
      <h5 class="inline-block px-6 py-3 my-12 text-xl bg-white dark:bg-gray-9 00 md:px-10 shadow-soft rounded-xl">
      ...
      <div class="flex justify-center mt-6 space-x-4">
        <a
          ...
          target="_blank"
          class="flex items-center space-x-2 shadow-soft btn btn-lg"
        >
          <octicon large />
